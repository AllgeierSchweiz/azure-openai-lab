...
-   Within the **_init_.py** file go to line 83 and change the if statement from **if IN_COLAB:** to **if True:**

![](https://cdn-images-1.medium.com/max/800/1*knGjntHpgFaJUZswaBgxSA.png)
